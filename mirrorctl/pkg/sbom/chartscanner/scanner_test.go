	...
	testCases := []struct {
		...
		},
		{
			...
			expectedImages: []types.Image{
				...
				{Name: "kubectl", Source: "docker.io/bitnami/kubectl:5.5.2"},
				{Name: "enterprise-logs-provisioner", Source: "docker.io/grafana/enterprise-logs-provisioner:latest"},
				{Name: "enterprise-logs-provisioner", Source: "docker.io/grafana/enterprise-logs-provisioner:5.5.2"},
				{Name: "enterprise-logs", Source: "docker.io/grafana/enterprise-logs:latest"},
				{Name: "enterprise-logs", Source: "docker.io/grafana/enterprise-logs:5.5.2"},
				{Name: "loki-canary", Source: "docker.io/grafana/loki-canary:latest"},
				{Name: "loki-canary", Source: "docker.io/grafana/loki-canary:5.5.2"},
				{Name: "loki-helm-test", Source: "docker.io/grafana/loki-helm-test:latest"},
				{Name: "loki-helm-test", Source: "docker.io/grafana/loki-helm-test:5.5.2"},
				{Name: "loki", Source: "docker.io/grafana/loki:latest"},
				{Name: "loki", Source: "docker.io/grafana/loki:5.5.2"},
		...
		},
		{
			...
			expectedImages: []types.Image{
				...
				{Name: "kubectl", Source: "europe-southwest1-docker.pkg.dev/poc-development-123456/test-container-images/bitnami/kubectl:5.5.2-poc"},
				...
				{Name: "enterprise-logs-provisioner", Source: "europe-southwest1-docker.pkg.dev/poc-development-123456/test-container-images/grafana/enterprise-logs-provisioner:5.5.2-poc"},
				...
				{Name: "enterprise-logs", Source: "europe-southwest1-docker.pkg.dev/poc-development-123456/test-container-images/grafana/enterprise-logs:5.5.2-poc"},
				...
				{Name: "loki-canary", Source: "europe-southwest1-docker.pkg.dev/poc-development-123456/test-container-images/grafana/loki-canary:5.5.2-poc"},
				...
				{Name: "loki-helm-test", Source: "europe-southwest1-docker.pkg.dev/poc-development-123456/test-container-images/grafana/loki-helm-test:5.5.2-poc"},
				{Name: "loki", Source: "europe-southwest1-docker.pkg.dev/poc-development-123456/test-container-images/grafana/loki:latest"},
				{Name: "loki", Source: "europe-southwest1-docker.pkg.dev/poc-development-123456/test-container-images/grafana/loki:5.5.2-poc"},
